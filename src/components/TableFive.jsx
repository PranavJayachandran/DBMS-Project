          ...
          <div className=" pb-4 w-6/12 pl-36 pr-16 flex justify-center pt-10">
            <div className="w-full">
              ...
              <div className="flex gap-4 mb-10">
                <div className="text-lg text-white">Month (in number)</div>
                <input
              ...
              <div className="flex justify-center ">
                <div
                  className="bg-white font-bold px-4 text-lg rounded-md hover:bg-black hover:text-white hover:cursor-pointer transition duration-300"
            ...
            <div className="border-l-2 px-20 my-10">
              ...
              <div>
                <div className="flex  text-lg   border-b-2 ">
                  <div className="w-6/12 text-white border-r-2 pb-1 ">
                    {" "}
                    Name
                  </div>
