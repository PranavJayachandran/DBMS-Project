        ...
        <div className="flex  rounded-3xl bg-[#9600CB] ">
          <div className="pb-4 w-7/12 pl-36 pr-16 flex justify-center pt-10 ">
            <div className="w-full">
              ...
              <div className="flex gap-8 mb-10 ">
                <div className="text-lg text-white">Complaints</div>
                <textarea
                  className="text-white px-2 py-1 h-20 flex-auto bg-[#9600CB] border-2 rounded-lg"
                  value={complaint}
              ...
              <div className="flex justify-center ">
                <div
                  className="bg-white font-bold px-4 text-lg rounded-md hover:bg-black hover:text-white hover:cursor-pointer transition duraition-300"
